...
func (lc *LinkCreate) SetFingerprint(s string) *LinkCreate {
	lc.mutation.SetFingerprint(s)
	return lc
}

// SetLabel sets the "label" field.
func (lc *LinkCreate) SetLabel(s string) *LinkCreate {
	lc.mutation.SetLabel(s)
	return lc
}

// SetNillableLabel sets the "label" field if the given value is not nil.
func (lc *LinkCreate) SetNillableLabel(s *string) *LinkCreate {
	if s != nil {
		lc.SetLabel(*s)
	}
	return lc
...
func (lc *LinkCreate) SetCreatedBy(s string) *LinkCreate {
	lc.mutation.SetCreatedBy(s)
	return lc
}

// SetNillableCreatedBy sets the "created_by" field if the given value is not nil.
func (lc *LinkCreate) SetNillableCreatedBy(s *string) *LinkCreate {
	if s != nil {
		lc.SetCreatedBy(*s)
	}
	return lc
...
func (lc *LinkCreate) SetCollectionID(id int) *LinkCreate {
	lc.mutation.SetCollectionID(id)
	return lc
}

// SetNillableCollectionID sets the "collection" edge to the Collection entity by ID if the given value is not nil.
func (lc *LinkCreate) SetNillableCollectionID(id *int) *LinkCreate {
	if id != nil {
		lc = lc.SetCollectionID(*id)
	}
	return lc
}

// SetCollection sets the "collection" edge to the Collection entity.
func (lc *LinkCreate) SetCollection(c *Collection) *LinkCreate {
	return lc.SetCollectionID(c.ID)
}
...
func (lc *LinkCreate) check() error {
	if _, ok := lc.mutation.Fingerprint(); !ok {
		return &ValidationError{Name: "fingerprint", err: errors.New(`ent: missing required field "Link.fingerprint"`)}
	}
	if v, ok := lc.mutation.Fingerprint(); ok {
		if err := link.FingerprintValidator(v); err != nil {
			return &ValidationError{Name: "fingerprint", err: fmt.Errorf(`ent: validator failed for field "Link.fingerprint": %w`, err)}
		}
	}
...
func (lc *LinkCreate) createSpec() (*Link, *sqlgraph.CreateSpec) {
	...
	if value, ok := lc.mutation.Fingerprint(); ok {
		_spec.SetField(link.FieldFingerprint, field.TypeString, value)
	...
	if nodes := lc.mutation.CollectionIDs(); len(nodes) > 0 {
		...
		_node.collection_links = &nodes[0]
